      ...
      <div className="wrap">
        ...
        <div className="doc">
          <div className="doc-h">
            ...
            <h1>How we work together, and what commercial viability will ask of {beneficiary}</h1>
            <p className="meta"><b>{beneficiary}</b>{programme ? <> · {programme}</> : null}{metaTail ? <> &nbsp;·&nbsp; {metaTail}</> : null} &nbsp;·&nbsp; nine decision blocks over about six months</p>
          </div>
          ...
          <div className="doc-b">
            ...
            <section>
              ...
              <div className="evidence">
                ...
                <p className="evnote">Every piece of evidence is logged in a single <b>Evidence Library</b> and referenced by number, so at any moment anyone can see what a decision was based on. This library is both the audit trail and, at the end, {beneficiary}&rsquo;s handover record. <b>&quot;Filled in&quot; is not the same as &quot;resolved.&quot;</b></p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="party p-lsp">
                <div className="pr"><span className="role">Beneficiary</span><span className="who">{beneficiary}</span><span className="cfg">set per engagement</span></div>
              ...
              <div className="party p-lead">
                ...
                <ul>
                  ...
                  <li>Co-evaluates and signs the handover, and gives written confirmation the model is complete and owned by {beneficiary}. Retains all intellectual property.</li>
                </ul>
              </div>
              ...
              <div className="gov">
                ...
                <div className="gcard" style={{ gridColumn: '1/-1' }}>
                  ...
                  <div className="moments">
                    ...
                    <div className="moment"><span className="mchip m-red">Red</span><span>Stalled, work pauses; the lead, {beneficiary}&rsquo;s leadership and the funder meet within five working days and agree a written recovery plan before resuming.</span></div>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="ip">
                The <b>Grant-to-Commercial Viability Canvas&trade;</b>, its tools, and the <b>ClearView</b> platform remain the intellectual property of The Canvas Coach. Everything produced <em>for {beneficiary}</em> during the engagement, the audit, the model, the value propositions, the pilot lessons, the growth plan, <b>belongs to {beneficiary}</b>{funder ? <>, with {funder}&rsquo;s rights as funder</> : null}. The method stays with the coach; the results stay with the organisation.
              </div>
            </section>
            ...
            <section>
              ...
              <div className="sig">
                {signatories.length === 0 ? (
                  ...
                  const forWho = p.organisation || (p.party_role === 'client_funder' ? funder : beneficiary)
