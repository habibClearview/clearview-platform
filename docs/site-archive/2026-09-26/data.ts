...
export const RESOURCES = [
  ...
  { kind: 'Newsletter', meta: 'Every Wednesday', name: 'Viable by Design, long edition', what: 'The longer version, from here rather than LinkedIn. More detail, more numbers, and the things I would not post publicly.', status: 'Live now' },
];
