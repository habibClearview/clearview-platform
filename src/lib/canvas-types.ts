...
export const CANVAS_DECISION_POINTS: DecisionPoint[] = [
  {
    id: 'dp01',
    number: 'Decision Point 1',
    zone: 'Decision Point 1 — Service Reality Audit',
  ...
  },
  {
    ...
    why_it_matters_for_ikore: 'Commercial viability is the point of the entire engagement. Without a working financial model, all the design work in Decision Point 1-03 remains theoretical.',
  ...
  },
  {
    ...
    components: [
      ...
      { id: 'dp07_c8', number: 8, title: 'Mid-Point Commercial Readiness Diagnostic', what_it_is: 'The second run of the Commercial Readiness Diagnostic, measuring progress since the baseline in Decision Point 6.', why_it_matters: 'The mid-point score provides evidence of commercial development progress for the funder and for Ikore\'s own planning.', action_trigger: 'Complete the Commercial Readiness Diagnostic again. Compare scores to the baseline from Decision Point 6. Note what changed and why.', signal_to_look_for: 'Scores have improved on at least 3 of the 6 fit tests. Score improvement is supported by evidence.', coach_guidance: 'Do not adjust scores to show improvement without evidence. Accurate scoring is more valuable than a favourable result.' },
      { id: 'dp07_c9', number: 9, title: 'Decision Point 7 Summary and Commitment', what_it_is: 'A written summary of Iteration 1: what was delivered, what was learned, what changes are planned for Iteration 2, signed by the CEO.', why_it_matters: 'CEO sign-off confirms that the organisation is committing to Iteration 2 with the agreed changes.', action_trigger: 'Write a one-page summary: pilot clients, revenue received, key learning, changes planned.', signal_to_look_for: 'Summary is specific. Mentions actual clients, actual revenue, actual changes. Not "we delivered training and it went well."', coach_guidance: 'This summary is a key piece of evidence for the funder. It demonstrates that the engagement is producing real commercial activity, not just planning.' },
    ]
  },
  {
    id: 'dp08',
    number: 'Decision Point 8',
    zone: 'Decision Point 7 — Pilot: Iteration 2 and Commercial Handover',
    ...
    why_it_matters_for_ikore: 'The engagement only succeeds if Ikore owns the model. Decision Point 8 is the transfer point: Ikore leads, consultant steps back.',
    session_time: '3 days on-site with lead consultant',
    components: [
      ...
      { id: 'dp08_c9', number: 9, title: 'Decision Point 8 Summary and Commitment', what_it_is: 'A written summary of Iteration 2 and commercial handover readiness, signed by the CEO.', why_it_matters: 'CEO sign-off signals readiness to proceed to Decision Point 9 final commercial readiness assessment.', action_trigger: 'Write a one-page summary: Iteration 2 outcomes, independence test results so far, commercial model status, readiness for handover.', signal_to_look_for: 'Summary is honest about what is ready and what is not. It identifies any remaining risks before handover.', coach_guidance: 'Do not allow an optimistic summary that obscures real gaps. The Decision Point 9 final diagnostic will reveal them anyway.' },
    ]
  },
  {
    id: 'dp09',
    number: 'Decision Point 9',
    zone: 'Decision Point 9 — Commercial Readiness Diagnostic',
...
export function getPhaseLabel(id: PhaseId): string {
  const map: Record<PhaseId, string> = {
    setup: 'Setup', phase0: 'Phase 0', dp01: 'Decision Point 1', dp02: 'Decision Point 2',
    dp03: 'Decision Point 3', dp04: 'Decision Point 4', dp05: 'Decision Point 5', dp06: 'Decision Point 6',
    dp07: 'Decision Point 7', dp08: 'Decision Point 8', dp09: 'Decision Point 9', handover: 'Handover',
  }
  return map[id]
}
