...
export const CANVAS_TABS = [
  ...
  { id: 'decisions',    label: 'Decision Record',           marker: '2',  group: 'record' },
  { id: 'evidence',     label: 'Evidence Library',          marker: '3',  group: 'record' },
  { id: 'hypothesis',   label: 'Hypothesis Tracker',        marker: '4',  group: 'record' },
