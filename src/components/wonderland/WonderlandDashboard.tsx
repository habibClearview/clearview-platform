      ...
      {activeSection==='summary'&&(
        <div>
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(160px,1fr))',gap:'1rem',marginBottom:'1.5rem'}}>
            ...
            <div style={{background:CC.white,border:'1px solid '+CC.border,borderRadius:6,padding:'1rem'}}><div style={{fontFamily:'monospace',fontSize:'0.68rem',color:CC.slate,textTransform:'uppercase',marginBottom:'0.35rem'}}>Revenue Trend</div><div style={{fontFamily:'Georgia,serif',fontSize:'1.3rem',fontWeight:700,color:revTrend==='Growing'?CC.green:revTrend==='Stable'?CC.amber:CC.red}}>{revTrend}</div><div style={{fontSize:'0.75rem',color:CC.slate}}>Q1 vs Q4 Y1</div></div>
          </div>
        </div>
      )}
