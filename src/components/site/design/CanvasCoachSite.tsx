    ...
    <section id="method" data-chapter="04" style={{background: "#c9a84c", color: "#2a1c04", padding: "clamp(56px, 6vw, 88px) 40px"}}>
      <div style={{maxWidth: "1440px", margin: "0 auto"}}>
        ...
        <div data-rise style={{display: "flex", flexWrap: "wrap", gap: "40px", marginBottom: "40px"}}>
          <p style={{flex: "1 1 340px", minWidth: "0", margin: "0", fontSize: "18px", color: "rgba(42,28,4,0.82)", lineHeight: "1.62", textWrap: "pretty"}}>Three of these are canvases. Every decision on one page, in order, so you can see the whole picture at once — and see which pieces do not fit.</p>
          <p style={{flex: "1 1 340px", minWidth: "0", margin: "0", fontSize: "18px", color: "rgba(42,28,4,0.82)", lineHeight: "1.62", textWrap: "pretty"}}>The other two are instruments rather than canvases. Market Intelligence collects and verifies the numbers from each business. The Trade Liquidity Multiplier structures a reserve so that it unlocks many times its own value in trade credit.</p>
        </div>
