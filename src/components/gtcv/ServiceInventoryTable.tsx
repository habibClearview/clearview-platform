        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', margin: '0.85rem 0 1rem' }}>
          {DECISIONS.map((d) => (
            <div key={d.v} style={{ borderTop: `3px solid ${d.color}`, background: C.alt, borderRadius: 8, padding: '0.5rem 0.9rem', minWidth: 96 }}>
              <div style={{ fontFamily: 'monospace', fontSize: '0.85rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: C.slate }}>{d.l}</div>
              <div style={{ fontFamily: 'Georgia,serif', fontSize: '1.5rem', fontWeight: 700, color: d.color, lineHeight: 1.1 }}>{counts[d.v]}</div>
            </div>
          ))}
          <div style={{ borderTop: `3px solid ${C.slate}`, background: C.alt, borderRadius: 8, padding: '0.5rem 0.9rem', minWidth: 96 }}>
            <div style={{ fontFamily: 'monospace', fontSize: '0.85rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: C.slate }}>Not decided</div>
            <div style={{ fontFamily: 'Georgia,serif', fontSize: '1.5rem', fontWeight: 700, color: C.slate, lineHeight: 1.1 }}>{counts.undecided}</div>
          </div>
        </div>
      )}
