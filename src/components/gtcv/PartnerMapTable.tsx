...
const th = { padding: '0.45rem 0.6rem', textAlign: 'left', fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', letterSpacing: '0.06em', textTransform: 'uppercase', fontWeight: 700, color: C.slate, borderBottom: `1px solid ${C.border}`, verticalAlign: 'bottom' }
    ...
    <div style={card}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '0.35rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
          {pill && (
            <span style={{ fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', color: pill.color, border: `1px solid ${pill.color}`, borderRadius: 999, padding: '0.15rem 0.6rem' }}>
              {pill.text}
            </span>
          )}
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', margin: '0.85rem 0 1rem' }}>
          {EFFECTS.map((e) => (
            <div key={e.v} style={{ borderTop: `3px solid ${e.color}`, background: C.alt, borderRadius: 8, padding: '0.5rem 0.9rem', minWidth: 108 }}>
              <div style={{ fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: C.slate }}>{e.l}</div>
              <div style={{ fontFamily: 'var(--cv-font)', fontSize: '1.5rem', fontWeight: 700, color: e.color, lineHeight: 1.1 }}>{counts[e.v]}</div>
            </div>
          ))}
          <div style={{ borderTop: `3px solid ${C.slate}`, background: C.alt, borderRadius: 8, padding: '0.5rem 0.9rem', minWidth: 108 }}>
            <div style={{ fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: C.slate }}>Not assessed</div>
            <div style={{ fontFamily: 'var(--cv-font)', fontSize: '1.5rem', fontWeight: 700, color: C.slate, lineHeight: 1.1 }}>{counts.unassessed}</div>
          </div>
        </div>
      )}
