                        ...
                        <td style={{ ...td, textAlign: 'right', whiteSpace: 'nowrap' }}>
                          {r.stage !== 'closed' && (
                            <button type="button" title="Move to the next stage" disabled={busy} onClick={() => advance(r)}
                              style={{ ...mono, border: 'none', background: 'transparent', color: C.cyan, cursor: 'pointer', fontSize: '1.01rem', padding: '0.2rem 0.3rem' }}>&gt;</button>
                          )}
                          <button type="button" title="Delete this prospect" disabled={busy} onClick={() => removeRow(r)}
                            style={{ ...mono, border: 'none', background: 'transparent', color: C.red, cursor: 'pointer', fontSize: '1.01rem', padding: '0.2rem 0.3rem' }}>x</button>
                        </td>
                      )}
                    </tr>
                  )
