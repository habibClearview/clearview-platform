              ...
              return (
                ...
                >
                  ...
                  <span>
                    ...
                    <span style={{ display: 'block', fontFamily: 'monospace', fontSize: '0.8rem', color: isExcluded ? C.red : C.slate }}>
    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginTop: '0.6rem', flexWrap: 'wrap' }}>
          ...
          {flagged && (
            <span style={{ fontFamily: 'monospace', fontSize: '0.87rem', color: C.amber, border: `1px solid ${C.amber}`, borderRadius: 999, padding: '0.15rem 0.6rem' }}>
              ...
              return (
                <div key={t.title} style={{ display: 'flex', gap: '0.6rem', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap' }}>
                  <div style={{ flex: '1 1 340px' }}>
                    ...
                    <div style={{ fontFamily: 'monospace', fontSize: '0.82rem', color: k ? k.color : C.slate }}>
    ...
    <div style={card}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '0.35rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
          {p && (
            <span style={{ fontFamily: 'monospace', fontSize: '0.87rem', color: p.color, border: `1px solid ${p.color}`, borderRadius: 999, padding: '0.15rem 0.6rem' }}>
              {p.text}
            </span>
          )}
      ...
      <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap', margin: '0.85rem 0 1.1rem' }}>
        {KINDS.map((k) => (
          <div key={k.v} style={{ borderTop: `3px solid ${k.color}`, background: C.alt, borderRadius: 8, padding: '0.45rem 0.75rem', minWidth: 132 }}>
            ...
            <div style={{ fontFamily: 'Georgia,serif', fontSize: '1.4rem', fontWeight: 700, color: k.color, lineHeight: 1.1 }}>
