...
const mono = { fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', letterSpacing: '0.08em', textTransform: 'uppercase', color: C.slate }
...
const warnBtn = { fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', padding: '0.3rem 0.7rem', border: `1px solid ${C.red}`, borderRadius: 6, background: 'transparent', color: C.red, cursor: 'pointer' }
  ...
  return (
    <div style={card}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '0.75rem', flexWrap: 'wrap' }}>
        ...
        <span style={{ fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', color: gateState.color, border: `1px solid ${gateState.color}`, borderRadius: 999, padding: '0.15rem 0.6rem' }}>
          {gateState.text}
        </span>
      </div>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                    {done ? (
                      <span style={{ fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', color: C.green }}>
                        Signed {fmtDate(record.signed_at)}
                      </span>
                    ) : (
                      <span style={{ fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', color: C.amber }}>Outstanding</span>
                    )}
                    {!done && myRole === role && (
            ...
            <>
              ...
              {returns.map((r) => (
                <div key={r.id} style={{ border: `1px solid ${C.red}`, borderRadius: 8, padding: '0.6rem 0.75rem', marginBottom: '0.4rem' }}>
                  <div style={{ fontFamily: 'var(--cv-font-mono)', fontSize: '1.01rem', color: C.red }}>
